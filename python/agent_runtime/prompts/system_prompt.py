...
def build_system_prompt(personality: Optional[Personality] = None) -> str:
    ...
    parts.append("")
    parts.append("At the end of each turn, before calling end_turn, take a moment to reflect:")
    parts.append("- What happened this turn?")
    parts.append("- How do you feel about the situation?")
    parts.append("- What are you planning?")
    parts.append("")
    parts.append("Record these reflections using `update_knowledge_base`. Your future self will thank you.")
    parts.append("Sections like 'strategy', 'relationships', 'turn_N_reflection' help maintain your narrative.")
    parts.append("")
    ...
    parts.append("**Remembering:** `query_knowledge_base`, `update_knowledge_base`, `get_log`")
